        ...
        {cartItems.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <h2 className="text-gray-700 text-xl mt-4 text-center">
              {isLoggedIn ? 'Your cart is empty. Add items to continue shopping.' : 'Please log in to view your cart.'}
            </h2>
            <button
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1 bg-white p-6 rounded-3xl shadow-lg">
              ...
              {cartItems.map((item) => (
                <div key={item.id} className="flex gap-6 border-t py-6 first:border-t-0">
                  ...
                  <div className="flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex gap-3 mt-2 items-center">
                        ...
                        <span className="line-through text-gray-400">₹{item.price + 300}</span>
                        <span className="text-green-600 font-semibold">30% off</span>
                      </div>
                      <p className="text-green-600 text-sm mt-1">2 offers available</p>
                    </div>
